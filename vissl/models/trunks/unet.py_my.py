...
class Unet(nn.Module):
    ...
    def forward(self, image: torch.Tensor, out_feat_keys: List[str] = None) -> torch.Tensor:
        """
        Args:
        ...
        """
        output = transform_model_input_data_type(image, self.model_config)
        stack = []
