...
# Unet from FastMRI
# https://raw.githubusercontent.com/facebookresearch/fastMRI/master/fastmri/models/unet.py
...
class Unet(nn.Module):
    ...
    def __init__(
        ...
        unetblock = UNetBlock(in_chans, out_chans, chans,num_pool_layers, drop_prob)
